...
export default function AfricanFood() {
  ...
  const title = useMemo(() => {
    ...
    return "Cuisine subsaharienne et africaine en ligne";
  ...
  const subtitle = useMemo(() => {
    ...
    return "Plats, sauces, grillades et spécialités culinaires subsahariennes et africaines, livrés directement au Maroc.";
  }, [selectedCategory, selectedSubCategory]);
